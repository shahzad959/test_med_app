  ...
  return (
    <nav>
      ...
      <ul className="nav__links active">
        ...
        <li className="link">
          <a href="/home">Home</a> {/* Use a valid URL */}
        </li>
        {/* List item for the 'Appointments' link */}
        <li className="link">
          <a href="/appointments">Appointments</a> {/* Use a valid URL */}
        </li>
        {/* List item for the 'Sign Up' link with a button */}
        <li className="link">
          <button className="btn1" onClick={handleSignUp}>Sign Up</button> {/* Use a button */}
        </li>
        {/* List item for the 'Login' link with a button */}
        <li className="link">
          <button className="btn1" onClick={handleLogin}>Login</button> {/* Use a button */}
        </li>
      </ul>
    </nav>
  );
